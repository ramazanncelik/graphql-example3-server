import { OnExecuteHook, OnSubscribeHook, Plugin as EnvelopPlugin, PromiseOrValue } from '@envelop/core';
import { ExecutionResult } from '@graphql-tools/utils';
import { YogaServer } from '../server.cjs';
import { FetchAPI, GraphQLParams, MaybeArray, YogaInitialContext } from '../types.cjs';
export type Plugin<PluginContext extends Record<string, any> = {}, TServerContext extends Record<string, any> = {}, TUserContext = {}> = EnvelopPlugin<YogaInitialContext & PluginContext> & {
    /**
...
export type RequestParser = (request: Request, url: URL) => PromiseOrValue<GraphQLParams> | PromiseOrValue<GraphQLParams[]>;
